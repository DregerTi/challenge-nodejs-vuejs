...
const emit = defineEmits(['update:descriptionHidden', "update:deleteBtn", "update:calendarBtn", "update:updateBtn", "update:setDateButton", "update:mdMenuExplore"])
...
<template>
  <div class="event-form">
    ...
    <div class="flex gap-4">
      <RouterLink class="w-full" :to="'/analytics/' + $route.params.site + '/explore/conversion-tunnel/' + $route.params.id">
