...
<template>
    <div class="container-menu">
        <header>
            <h2>Audience</h2>
            <p>Learn more about the audience that visit your website</p>
        </header>
        <section>
            <MenuButton
                icon="Group"
                title="Total users"
                description="Displays the total number of users on your website"
                :path="'/analytics/' + $route.params.site + '/audience/total-users'"
            />
            <MenuButton
                icon="PersonAdd"
                title="New users"
                description="Tracks the number of new users visiting your website"
            ...
            <MenuButton
                ...
                :path="'/analytics/' + $route.params.site + '/audience/sessions'"
            />
            <MenuButton
                icon="AutoTimer"
            ...
            <MenuButton
                icon="TrendingUp"
                title="Page views"
                description="Ranking and performance of your individual pages"
                :path="'/analytics/' + $route.params.site + '/audience/page-views'"
            />
            <MenuButton
                icon="Devices"
                title="Devices"
                description="User devices accessing your website"
                :path="'/analytics/' + $route.params.site + '/audience/devices'"
            />
            <MenuButton
                icon="Explore"
                title="Localisation"
                description="Identifies the geographic location of visitors"
                :path="'/analytics/' + $route.params.site + '/audience/localisation'"
            />
        </section>
    </div>
</template>
